...
public class ListParamsForChangingWindow : ViewMethods
{
    ...
    public override void SetParams()
    {
        _listParamsForChanging.text =
            ApplicationData.AppData.ListHum[ApplicationData.AppData.ChosenNumberOfHuman].ListChanges();
    }
    ...
    private void SaveInformation()
    {
        ...
        {
            _maxValue = ApplicationData.AppData.ListHum[ApplicationData.AppData.ChosenNumberOfHuman] is Student ? 7: 
                ApplicationData.AppData.ListHum[ApplicationData.AppData.ChosenNumberOfHuman] is Driver? 9:
                ApplicationData.AppData.ListHum[ApplicationData.AppData.ChosenNumberOfHuman] is Employer? 7: 0;
        }
        ...
        if (!string.IsNullOrEmpty(_input.text) && _maxValue != 0)
        {
            ...
            {
                ApplicationData.AppData.ChosenNumberOfParam = int.Parse(_input.text);
